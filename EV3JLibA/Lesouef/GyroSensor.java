...
public class GyroSensor extends Sensor
{
  ...
  public double AngleFactorCorrector=1.;// facteur correcteur des angles pour le gyroscope
  /**
...
//    sp = gs.getAngleMode();
  ...
  public lejos.hardware.sensor.EV3GyroSensor getLejosSensor()
  {
	...
	public void setAngleFactor(double factor)
	{
		AngleFactorCorrector=factor;
	}
 ...
 //   LCD.drawString("Mode: " + sm.getName(), 0, 6);
    ...
    return (int)(samples[0]*AngleFactorCorrector);
  }
