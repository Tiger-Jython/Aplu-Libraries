 ...
 * The red LED is automatically turned on.
 */
public class LightSensor extends Sensor
{
  ...
  protected void cleanup()
  {
    ...
    if (lst != null)
      lst.stopThread();
    cs.setFloodlight(lejos.robotics.Color.NONE);
    cs.close();
  }
  ...
  private int getLevel()
  {
    if (robot == null)
      return -1;
    return (int)(1500 * getSensorValues()[0]);
  }
  ...
  /**
   * Polls the sensor.
   * @return the current value the sensor reported: 0 (dark) .. >1000 (bright)
   */
  public int getValue()
  {
    checkConnect();
    int v =  (int)(1500 * getSensorValues()[0]);
    return v;
