...
// -------------- End of inner classes -----------------------
  ...
  private lejos.hardware.sensor.EV3TouchSensor ts;
  ...
  public TouchSensor(SensorPort port)
  {
    ...
    ts = new lejos.hardware.sensor.EV3TouchSensor(getLejosPort());
  }
   ...
   * @return the reference of the lejos.hardware.sensor.EV3TouchSensor
   */
