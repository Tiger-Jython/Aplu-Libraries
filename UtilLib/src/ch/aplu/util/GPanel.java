...
//
  ...
  /**
   * Registers the given MouseMotionListener to get notifications for 
   * mouse motion events.
   */
  ...
  /**
   * Registers the given MouseWhelListener to get notifications for
   * mouse wheel events.
   */
   ...
   * See GPane.setDoubleClickDelay() to get information about 
  ...
  {
    _gPane.addMouseDoubleClickListener(listener);
  }
  ...
  {
    _gPane.setKeyListener(listener);
  }
   ...
   * @return current number of GPanel windows
   */
  public static int getInstanceCount()
  {
    return GPane.getInstanceCount();
  }
  ...
  {
    check();
    return _gPane.drawNode(xCenter, yCenter, text, size, borderSize,
      borderColor, textColor, bgColor, font);
  }
